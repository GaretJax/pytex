...
class Compare(Command):
    ...
    name = "diff"
    help = (
        "Creates a PDF document highlighting the changes"
    ...
    def execute(self, args):
        ...
        shutil.copytree(
            to_dir, diff_dir, ignore=shutil.ignore_patterns("*.tex")
        )
        ...
        dest = os.path.join(
            base, "{}-diff-{}-{}.pdf".format(name, args.from_ref, args.to_ref)
        )
